	...
	<section>
		<div class="container">
			<div class="row">
				...
				<?php
					$sql = "SELECT * FROM sanpham WHERE SoLuong>=50 LIMIT 3";;
					$pdo_stm = $conn->query($sql);//thực hiện lệnh sql trả về PDOStatement
					if($pdo_stm==NULL)
						die("<H3>LỖI SQL</H3>");
					$n =$pdo_stm->rowCount();//lấy số bản ghi kết quả
				...
				<?php
					$sql = "SELECT * FROM sanpham WHERE SoSao=5 LIMIT 3";;
					$pdo_stm = $conn->query($sql);//thực hiện lệnh sql trả về PDOStatement
					if($pdo_stm==NULL)
						die("<H3>LỖI SQL</H3>");
					$n =$pdo_stm->rowCount();//lấy số bản ghi kết quả
				...
				<?php
					$sql = "SELECT * FROM sanpham WHERE DonGia=1000000 LIMIT 3";;
					$pdo_stm = $conn->query($sql);//thực hiện lệnh sql trả về PDOStatement
					if($pdo_stm==NULL)
						die("<H3>LỖI SQL</H3>");
					$n =$pdo_stm->rowCount();//lấy số bản ghi kết quả
				...
				<?php
					$sql = "SELECT * FROM sanpham WHERE MaLSP=20 LIMIT 3";;
					$pdo_stm = $conn->query($sql);//thực hiện lệnh sql trả về PDOStatement
					if($pdo_stm==NULL)
						die("<H3>LỖI SQL</H3>");
					$n =$pdo_stm->rowCount();//lấy số bản ghi kết quả

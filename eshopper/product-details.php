					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									<span>$<?=$row["DonGia"]?> đ</span>
									<label>Số lượng:</label>
									<input type="text" value="1" />
									<button type="button" class="btn btn-fefault cart">
										<a href="addcart.php?MaSP=<?=$row["MaSP"]?>"><i class="fa fa-shopping-cart"></i>
										Thêm vào giỏ</a>
									</button>
								</span>
								<p><b>Hiện trạng:</b> Còn Hàng</p>
								<p><b>Hàng:</b> New</p>
								<p><b>Sản phẩm của:</b>FishCadoo</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li><a href="#" data-toggle="tab">Mô tả</a></li>

            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="white_box mb_30">
                        ...
                        ?>
                          <form name="f1" id="f1" method="post" action="xlythemnguoidung.php" enctype="multipart/form-data">
                          <table class="table table-bordered">
                                ...
                                <tbody>
                                  <tr>
                                    <th scope="row">Họ</th>
                                    <td><input style="width:400px;" type="text" name="Ho" id="Ho"></td>
                                  </tr>
                                  <tr>
                                    <th scope="row">Tên<nav></nav></th>
                                    <td><input style="width:400px;" type="text" name="Ten" id="Ten"></td>
                                  </tr>
                                  <tr>
                                    <th scope="row">Giới tính</th>
                                    <td>
                                      Nam <input type="radio" name="rGioitinh" id="r1" value="0"> &nbsp; &nbsp; &nbsp;
                                      Nữ  <input type="radio" name="rGioitinh" id="r2" value="1">
                                    </td>
                                  </tr>
                                  <tr>
                                    <th scope="row">Sdt</th>
                                  ...
                                  <tr>
                                    ...
                                    <td width="300"><input type="file" name="fHinhanh" id="fHinhanh"></td>
                                  </tr>
                                  <tr>
                                    <th scope="row">Tài Khoản</th>
                                    <td><input style="width:400px;" type="text" name="TaiKhoan" id="TaiKhoan" ></td>
                                  </tr>
                                  <tr>
                                    <th scope="row">MatKhau</th>
                                    <td><input style="width:400px;" type="text" name="MatKhau" id="MatKhau" ></td>
                                  </tr>
                                  <!-- <tr>
                                    <th scope="row">Phân Quyền</th>
                                    <td><input style="width:400px;" type="text" name="MaQuyen" id="MaQuyen" ></td>
                                  </tr> -->
                                  <tr>
                                    <th scope="row">Phân Quyền</th>
                                      <td>
                                        <select style="width:400px;" name="MaQuyen" id="MaQuyen">
                                        <?php
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        <input type="submit" class="status_btn" name="n1" id="n1" value="Đồng ý ">&nbsp; &nbsp; 
                                        <input type="reset" class="status_btn"name="n2" id="n2" value="Nhập lại ">
                                    </td>
                                  </tr>
                                </tbody>
                            </table>

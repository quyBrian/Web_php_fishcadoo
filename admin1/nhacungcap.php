                    ...
                    <div class="QA_section">
                        ...
                        <div class="QA_table ">
                            ...
                            <table class="table lms_table_active">
                                ...
                                <tbody>
                                    <tr>
                                        <td width="10%"> <?=$row["id_ncc"]?></td>
                                        <td width="50%"> <?=$row["tenncc"]?></td>
                                        <td width="10%"> <?=$row["diachi"]?></td>
                                        <td width="10%"> <?=$row["email"]?></td>
                                        <td width="50%"> <?=$row["sdt"]?></td>
                                        <td width="10%"> <?=$row["ngaytao"]?></td>
                                        <td width="10%"> <?=$row["ghichu"]?></td>
                                        <td>

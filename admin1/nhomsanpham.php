                    ...
                    <div class="QA_section">
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                <div class="add_button ml-10">
                                    <a href="themnhomsanpham.php" class="btn_1">Thêm nhóm sản phẩm</a>
                                </div>
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="QA_table ">
                            ...
                            <table class="table lms_table_active">
                                ...
                                <tbody>
                                    <tr>
                                        <td width="10%"> <?=$row["MaLSP"]?></td>
                                        <td width="50%"> <?=$row["TenLSP"]?></td>
                                        <td width="10%"> <?=$row["HinhAnh"]?></td>
                                        <td width="10%"> <?=$row["Mota"]?></td>
                                        <td>
                                            <a href="SuaNhomSP.php?MaLSP=<?=$row["MaLSP"]?>" class="status_btn">Sửa</a>
                                        </td>
                                        <td>
                                            <a href="xoanhomsp.php?MaLSP=<?=$row["MaLSP"]?>" class="status_btn" onClick="return confirm('chắc xóa không?');">Xóa</a>
                                        </td>
                                    </tr>
                                </tbody>
                                <?php

                        ...
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                <div class="add_button ml-10">
                                    <a href="themsanpham.php" class="btn_1">Thêm sản phẩm</a>
                                </div>
                            </div>
                        </div>
                        <?php
                            ...
                            <table class="table lms_table_active">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td > <?=$row["GhiChu"]?></td>
                                        <td>
                                            <a href="suasanpham.php?MaSP=<?=$row["MaSP"]?>" class="status_btn">Sửa</a>
                                            <a href="xoasanpham.php?MaSP=<?=$row["MaSP"]?>" class="status_btn" onClick="return confirm('chắc xóa không?');">Xóa</a>
                                        </td>
                                    </tr>
                                </tbody>
                                <?php
